...
async def data_handler(data):
    ...
    try:  # try to decode the data, if it fails, throw exception
        ...
        if data_str.endswith(']') and (data_str.startswith('[') or data_str[0] == '\x00'):
            ...
            quat0_w, quat0_x, quat0_y, quat0_z, quat1_w, quat1_x, quat1_y, quat1_z, quat2_w, quat2_x, quat2_y, quat2_z, accel0_x, accel0_y, accel0_z, accel1_x, accel1_y, accel1_z, accel2_x, accel2_y, accel2_z = data_list
            if sql_used:
